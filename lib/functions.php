 ...
 * name with a 'switchboard:' prefix. Simply pass 'null' (or a fallback value of
 * your choosing) as the first filter argument, then the remaining function
 * params as appropriate. For instance,
 *
 *     $site_term = apply_filters( 'switchboard:get_current_site_term', null );
 *     $site_slug = apply_filters( 'switchboard:get_current_site_term', null, 'slug' );
 *
 * @package Switchboard
 */
...
add_filter( 'switchboard:get_current_site_term', __NAMESPACE__ . '\get_current_site_term', 10, 2 );
...
add_filter( 'switchboard:get_post_primary_site', __NAMESPACE__ . '\get_post_primary_site', 10, 2 );
...
add_filter( 'switchboard:get_sites_for_post', __NAMESPACE__ . '\get_sites_for_post', 10, 2 );
...
add_filter( 'switchboard:is_post_allowed_on_current_site', __NAMESPACE__ . '\is_post_allowed_on_current_site', 10, 2 );
...
add_filter( 'switchboard:get_post_site', __NAMESPACE__ . '\get_post_site', 10, 3 );
